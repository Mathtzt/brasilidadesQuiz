...
import NavHomePage from "../../components/NavToHome";
...
function getQuestoesByDificuldade(externalQuestions) {
    const nivel = getRouterParams().nv;
    if (nivel === dificuldadeStates.DIFICIL) {
        return externalQuestions.questionsDifficult;
    } else if (nivel === dificuldadeStates.MEDIO) {
        return externalQuestions.questionsMedium;
    } else {
...
export default function QuizPage({externalQuestions, externalBg}) {
    ...
    const dificuldadeQuestions = getQuestoesByDificuldade(externalQuestions);
